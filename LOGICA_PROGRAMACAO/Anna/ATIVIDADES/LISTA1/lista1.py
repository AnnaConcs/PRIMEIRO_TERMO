...
# (print(135+246))
# (print(512-128))
# pv1 = int(input("Qual é o primeiro valor?: \n"))
# pv2 = int(input("Qual é o segundo valor?: \n"))
# print("O resultado é:", pv1+pv2)
# pv1 = int(input("Qual é o primeiro valor?: \n"))
# pv2 = int(input("Qual é o segundo valor?: \n"))
# print("O resultado é:", pv1-pv2)
...
# pv1 = int(input("Qual a quantidade de peças boas?: \n"))
# pv2 = int(input("Qual a quantidade de peças defeituosas?: \n"))
# total = pv1+pv2
# print("O resultado de peças é", total)
# taxa = pv1/total
# print("O resultado da taxa de reaproveitamento é", taxa)
...
# print("Eu tenho 16 anos e em 10 anos eu terei", 16+10)
...
# valor = (250.50 * 3) + 412
# print("O valor total é da sua viagem é", valor)
...
produto = input("Qual produto você gostaria de comprar?:")
qtd = int(input("Qual seria a quantidade desse produto?:"))
preço = int(input("qual é o preço desse produto?:"))
valor = qtd * preço 
print("Valor total da venda:", valor)
print("=============================")
print("Relatório de Vendas")
print("=============================")
print("Produto comprado:", produto)
print("Quantidade de produto comprado:", qtd)
print("Preço unitário do produto comprado:", preço)
print("Valor total da sua compra foi de:", valor)