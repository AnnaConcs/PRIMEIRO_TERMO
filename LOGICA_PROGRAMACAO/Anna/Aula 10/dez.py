...
# Exercício 1
# Escreva um programa que solicite ao usúario calcule a média de três números. O programa deve lidar com possíveis erros, como a entrada de valores não numéricos ou a divisão por zero.

# try:
#  numero1 = int(input("Digite um número: "))
#  numero2 = int(input("Digite o segundo número: "))
#  numero3 = int(input("Digite o terceiro número: "))
#  total = 3 / numero1 + numero2 + numero3
...
# print(f"calcular media {(calcular_media(10, 20, 30))}")
...
# Exemplo 4: 
# Calcule o dobro de um número fornecido pelo usúario, tratando erros de entrada inválida.
# def calcular_dobro():
#     try:
